function Scene0()
{
	...
	HTML='<img src="pictures/wys/wys3.gif" style="left:35px;top:341px;z-index:36"><img src="pictures/wys/wys2.gif" style="left:566px;top:0px;z-index:36"><img src="pictures/wys/wys4.gif" style="left:1107px;top:349px;z-index:36"><img src="pictures/wys/wys1.gif" style="left:1210px;top:51px;z-index:36">';

	for(var i=1;i<=40;i++){
		HTML+='<img src="pictures/wys/wys_'+i+'.jpg" style="position:static;">';
		if(i%10==0&&i!=40)
			HTML+='<br>';
